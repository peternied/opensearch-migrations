package org.opensearch.migrations.lucene6;
...
public class Lucene6Upgrader implements LuceneUpgrader {
    ...
    public void upgradeIndex(String indexPath) {
        try (FSDirectory dir = FSDirectory.open(Paths.get(indexPath))) {
            ...
            System.out.println("Lucene6 issue: " + e.getClass().getSimpleName() + ", " + e.getMessage());
        } finally {
